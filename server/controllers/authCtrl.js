...
module.exports = {
   register: async (req, res) => {
    ...
    login: async (req, res) => {
        ...
        req.session.user = {client_id: clientArr[0].client_id, email: clientArr[0].email, firstName: clientArr[0].first_name, lastName: clientArr[0].last_name, admin: clientArr[0].is_admin}
        res.status(200).send({
